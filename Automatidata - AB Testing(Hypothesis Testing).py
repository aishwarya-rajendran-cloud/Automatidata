...
# **Answer:** To find the relationship between Fare amount and Payment type
...
# **Answer** Descriptive statistics helps to understand the data overall. It gives us mean value, minimun and maximum value. the number of unique data and frequency of data repeating in a single column can be given in a gist using descriptive statistics
...
# The P- value `6.797387473030518e-12` is lesser than significance level 5%. `The Null Hypothesis is rejected`
...
# **Insights:** 1.  The key business insight identified as that there is significant difference in the average customers payment method. If we encourage customers by giving credit points and rewards for using credit card that may create a loyal customer base 
